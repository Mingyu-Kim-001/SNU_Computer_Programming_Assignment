...
public class Test {
    ...
    static boolean test(Map<String,Map<String,List<Double>>> result, Map<String,Map<String,List<Double>>> expected) {
        ...
        if (!(expected.keySet()).equals(result.keySet())) {
            System.out.println("not align keyset : "+result.keySet().toString());
            System.out.println(expected.keySet().toString());
            return false;
        }
...
//                System.out.println(id + " \n" + gradesResult.keySet().toString() + "\n" + gradesExpected.keySet().toString());
                return false;
            }
            //System.out.println(gradesResult.keySet().toString());
            for (String problem : gradesResult.keySet()) {
                ...
                //if(problem.equals("problem3")) System.out.println("res " + res.toString());
